...
class TermPolicyModal extends React.Component {
  render() {
    return (
      <Modal
        isVisible={this.props.modalVisible}
        onBackdropPress={() => {
          this.props.offModalVisible();
        }}
        onRequestClose={() => {
          this.props.offModalVisible();
        }}
        style={{ margin: 0, justifyContent: 'flex-end' }}>
        <View style={{ flex: 1, marginTop: 65, marginBottom: 65, marginHorizontal: 25, backgroundColor: 'white' }}>
          <View style={{ alignItems: 'flex-end', padding: 10, paddingTop: 12, backgroundColor: '#642AC8' }}>
            <Text
              onPress={() => {
                this.props.offModalVisible();
              }}>
              <AntDesign name="closecircleo" size={30} color="#fff" style={{}} />
            </Text>
          </View>
