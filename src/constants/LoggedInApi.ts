...
export default {
    ...
    monthLists: (STORE_ID: string,
        EMP_ID: string,
        YEAR: number,
        MONTH: number) => noPortApi("get", `/PayMents/month_lists?STORE_ID=${STORE_ID}&EMP_ID=${EMP_ID}&YEAR=${YEAR}&MONTH=${MONTH}`),
    ...
    getChecklist2: (STORE: string,
        DATE: string) => oldApi("get", `/Store/Checklist2?STORE=${STORE}&DATE=${DATE}`),
